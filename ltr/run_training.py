...
def main():
    ...
    parser.add_argument('--train_name', 
                        ...
                        # default='swin_transt_qkvcnn_enhance_withconv_encoderfusion',
                        # default='swin_transt_qkvcnn_enhance_withoutconv_encoderfusion',
                        # default='swin_transt_qkvcnn_encoderfusion_withoutconv',
                        default='swin_transt_qkvcnn_encoderfusion_enhance',
                        # default='transt',

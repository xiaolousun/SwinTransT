...
import ltr.models.tracking.swin_transt_qkvcnn_encoderfusion_withoutconv as swintranst_models
...
def run(settings):
    ...
    settings.env.workspace_dir = '/home/xlsun/xlsun/code/TransT/results/SwinTransT_Cvt_diffcnn'

...
import ltr.models.tracking.swin_transt_qkvcnn_encoderfusion_enhance as swintranst_models
...
def run(settings):
    ...
    settings.env.workspace_dir = '/home/xlsun/xlsun/code/TransT/results/SwinTransT_Cvt_encoderfusion_enhance'
    ...
    trainer.train(1000, load_latest=False, fail_safe=False)

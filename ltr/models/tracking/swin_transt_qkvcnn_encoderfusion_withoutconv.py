...
from ltr.models.neck.encoder_featurefusion_network import build_encoder_featurefusion_withoutdwconv_network
...
def transt_swintranst(settings):
    ...
    featurefusion_network = build_encoder_featurefusion_withoutdwconv_network(params, settings, output_layer)
    model = SwinTransT(
        backbone_net,

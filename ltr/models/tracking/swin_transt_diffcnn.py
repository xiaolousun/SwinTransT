...
from ltr.models.backbone.swin_transt_backbone import build_swin_transformer_diffcnn_backbone
...
def transt_swintranst(settings):
    ...
    backbone_net = build_swin_transformer_diffcnn_backbone(settings, name, load_pretrained=False)

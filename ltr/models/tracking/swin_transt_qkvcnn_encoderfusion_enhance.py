...
from ltr.models.neck.encoder_featurefusion_network import build_encoder_featurefusion_enhance_network
...
def transt_swintranst(settings):
    ...
    featurefusion_network = build_encoder_featurefusion_enhance_network(params, settings, output_layer, need_dwconv=True)
    model = SwinTransT(
        backbone_net,

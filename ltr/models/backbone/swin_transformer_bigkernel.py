...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(self, dim, num_heads, window_size=7, shift_size=0,
        ...
        self.dwconv_block = build_DwConv_Bigkernel_Block(in_planes=dim, out_planes=dim)
...
class SwinTransformer_Bigkernel(nn.Module):
    def __init__(self,
                 pretrain_img_size=224,
                 patch_size=4,
                 in_chans=3,
                 ...
                 frozen_stages=-1,
                 use_checkpoint=False):
        super(SwinTransformer_Bigkernel, self).__init__()
    ...
    def train(self, mode=True):
        ...
        super(SwinTransformer_Bigkernel, self).train(mode)
        _freeze_stages(self.stages, self.frozen_stages, self.ape)
...
def build_swin_transformer_backbone(name, load_pretrained=True, output_layers=(3,), frozen_stages=-1,
    ...
    if overwrite_embed_dim is not None:
        ...
        pretrained_model_path = None
    transformer = SwinTransformer_Bigkernel(out_indices=output_layers, frozen_stages=frozen_stages, **params)
